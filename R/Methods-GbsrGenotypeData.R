...
setMethod("setCallFilter",
          ...
          function(object,
              ...
              .create_gdsn(gdsn = object$root,
                           target_node = "annotation/format",
                           new_node = "CFT",
                           val = 0L,
                           storage = "uint8",
                           valdim = c(nsam(object, FALSE), nmar(object, FALSE)),
                           replace = TRUE,
                           attr = list(Number = "1",
                                       Type = "Integer",
                                       Description = "Call filter information generated by GBScleanR"))
              ...
              sample_filter <- .makeSampleCallFilter(object, filt_list)
...
.SampleCallFilter <- function(object, i, filt_list){
